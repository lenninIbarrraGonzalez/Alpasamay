...
//posición en X
var posX = [115, 274, 432, 589, 733, 194, 352, 508, 655, 115, 274, 432, 589, 733, 194, 352, 508, 655];
//posición en Y 475
var posY = [477, 477, 477, 477, 477, 519, 519, 519, 519, 477, 477, 477, 477, 477, 519, 519, 519, 519];
debugger
for(var i=0; i<parts_colors.length; i++){
    ...
    parts_colors[i].setAttribute("x", posX[i]);
    parts_colors[i].setAttribute("y", posY[i]);
    // if(i < 9){
    ...
    // }
    parts_colors[i].setAttribute("onmousedown", "seleccionarElemento(evt)");
}
...
// menta 440 375 
// azultugtu 370 379
// ridondo panga 540 417
// alpa culantro 640 375
// namis 45 210
// sicsi 6 308
